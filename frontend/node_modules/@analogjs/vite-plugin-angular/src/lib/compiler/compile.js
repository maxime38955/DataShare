            ...
            switch (decoratorName) {
                ...
                case 'Service': {
                    ...
                    if (!angularVersionAtLeast(22)) {
                        classCompileError = new Error(`[fast-compile] @Service on ${className} requires Angular 22 or later`);
                        break;
                    }
                    ...
                    if (meta.autoProvided === false)
                        serviceMeta.autoProvided = false;
                    if (meta.factory)
                        serviceMeta.factory = meta.factory;
                    if (isPartial) {
